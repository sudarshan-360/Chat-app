...
const RightSidebar = ({ setRightSidebarOpen }) => {
  const mediaImages = [
    { src: assets.img1, alt: 'Image 1' },
    { src: assets.img2, alt: 'Image 2' },
    { src: assets.pic1, alt: 'Picture 1' },
    { src: assets.pic2, alt: 'Picture 2' },
    { src: assets.pic3, alt: 'Picture 3' },
    { src: assets.pic4, alt: 'Picture 4' }
  ]
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="space-y-4 sm:space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {mediaImages.map((image, index) => (
                <div 
                  ...
                  className="aspect-square bg-white/5 rounded-lg overflow-hidden cursor-pointer hover:bg-white/10 transition-colors group"
                >
                  <img 
                    src={image.src} 
                    alt={image.alt}
            ...
            <button className="w-full mt-3 p-2 text-blue-400 hover:bg-white/10 rounded-lg transition-colors text-sm">
              View All Media
            </button>
          </div>
